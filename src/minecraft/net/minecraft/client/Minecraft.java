...
import us.blockgame.client.util.KeyboardUtil;

public class Minecraft implements IPlayerUsage {
	private static final Logger logger = LogManager.getLogger();
	private static final ResourceLocation locationMojangPng = new ResourceLocation("loading.png");
	...
	public Minecraft(Session p_i1103_1_, int p_i1103_2_, int p_i1103_3_, boolean p_i1103_4_, boolean p_i1103_5_,
		...
		DiscordUtil.username = p_i1103_1_.getUsername();
	...
	private void startGame() throws LWJGLException {
		...
		Display.setTitle("BlockGame Client 1.7.10");
	...
	public void shutdownMinecraftApplet() {
		BlockClient.getInstance().getManagerHandler().getDataManager().save();
		...
		if (this.currentScreen == null || this.currentScreen.field_146291_p) {
			...
			while (Mouse.next()) {
				...
				if (var11 <= 200L) {
					...
					if (this.currentScreen == null) {
						KeyboardUtil.handleMouseInput(var9);
			...
			while (Keyboard.next()) {
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						KeyboardUtil.handleKeyboardInput(Keyboard.getEventKey());
