...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation minecraftTitleTextures = new ResourceLocation("blockgame.png");
    private static final ResourceLocation background = new ResourceLocation("background.png");
    ...
    public void initGui()
    {
        ...
        this.splashText = "BlockGame Client? No way!";
        boolean var2 = true;
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, p_73969_1_ + 10, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1 + 10, I18n.format("menu.multiplayer", new Object[0])));
        //this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2 + 10, "Cosmetics"));
    }
    ...
    public static void drawLogo()
    {
        ...
        drawTextureWithOptionalSize(width / 2 - 50, height / 4 - 50, 0, 0, 100, 100, 100, 100);
    }

    
    public static void drawTextureWithOptionalSize(int x, int y, int u, int v, int width, int height, int uSize, int vSize)
    {
    ...
    public static void drawGui()
    {
        ...
        Tessellator var2 = Tessellator.instance;
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, 0);
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("gui.png"));
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        var2.startDrawingQuads();
        var2.addVertexWithUV(0.0D, height + 100, 0.0D, 0.0D, 1.0D);
        var2.addVertexWithUV(width - 100, height - 100, 0.0D, 1.0D, 1.0D);
        var2.addVertexWithUV(width + 100, 0.0D, 0.0D, 1.0D, 0.0D);
        var2.addVertexWithUV(0.0D, 0.0D, 0.0D, 0.0D, 0.0D);
        var2.draw();
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        drawBackground();
        drawLogo();
        if (!BlockClient.loadedSettings) {
    		BlockClient.getInstance().getManagerHandler().getDataManager().loadSettings();
    		BlockClient.loadedSettings = true;
        }
