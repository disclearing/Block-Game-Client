...
public class GuiConnecting extends GuiScreen {
	...
	private void func_146367_a(final String p_146367_1_, final int p_146367_2_) {
		...
		GuiMultiplayer.updatedPresence = false;
			...
			public void run() {
				...
				try {
					...
					GuiConnecting.this.field_146371_g
							.setNetHandler(new NetHandlerLoginClient(GuiConnecting.this.field_146371_g,
									GuiConnecting.this.mc, GuiConnecting.this.field_146374_i));
					...
					if (BlockClient.getInstance().getManagerHandler().getSettingsManager().managerHandler
							.getSettingsManager().getBlockClientServers().contains(p_146367_1_.toLowerCase())) {
						BlockClient.getInstance().getManagerHandler().getSettingsManager().setAntiCheatEnabled(true);
						System.out.println("AntiCheat enabled.");
					} else if (BlockClient.getInstance().getManagerHandler().getSettingsManager()
							.isAntiCheatEnabled()) {
						BlockClient.getInstance().getManagerHandler().getSettingsManager().setAntiCheatEnabled(false);
						System.out.println("AntiCheat disabled.");
					}
					DiscordUtil.serverIp = p_146367_1_ + ":" + p_146367_2_;
					...
					GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.field_146374_i,
							"connect.failed",
					...
					GuiConnecting.this.mc
							.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed",
	...
	public void initGui() {
		...
		this.buttonList.add(
				new GuiButton(0, this.width / 2 - 100, this.height / 2 + 50, I18n.format("gui.cancel", new Object[0])));
	}
