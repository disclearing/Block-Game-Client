...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_)
    {
        ...
        if (BlockClient.getInstance().getManagerHandler().getSettingsManager().getSpecialEarsUsers().contains(p_77029_1_.getGameProfile().getName()) && p_77029_1_.func_152123_o())
        {
